...
public class Swimming extends JFrame {
	...
	public Swimming() {
		...
		btnIniciar.setBounds(5, 407, 191, 59);
		...
		btnSalir.setBounds(206, 405, 183, 63);
		btnSalir.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				int O = JOptionPane.showInternalConfirmDialog(null, "¿quieres salir?","¿Seguro?", JOptionPane.INFORMATION_MESSAGE, JOptionPane.YES_NO_OPTION);
